...
//unit count [boss, soldier, spear], unit growth per spawn [boss, soldier, spear]

maps= [[1, 100, 0, 3000, 15, 0, 0, 60*60, 6, [0, 1, 0], [0, 0, 0]],
		[2, 200, 80, 13000, 15, 0, 0, 60*62, 6, [0, 2, 0], [0, .34, .1]],
		[3, 500, 310, 27000, 15, 0, 0, 60*64, 3, [0, 5, 0], [0, .25, .25]],
		[5, 1100, 80, 60000, 10, 0, 0, 60*68, 2, [0, 12, 0], [0, 0, .5]],
		[8, 1700, 3000, 400000, 15, 0, 0, 60*70, 5, [0, 15, 7], [0, .2, .2]],
		[13, 3000, 15, 6000, 45, 0, 0, 120*72, 1, [0, 1, 0], [0, 0, 0]],
		[8, 1700, 3000, 400000, 15, 0, 0, 60*70, 5, [0, 15, 7], [0, .2, .2]],
		[8, 1700, 3000, 400000, 15, 0, 0, 60*70, 5, [0, 15, 7], [0, .2, .2]],
		[8, 1700, 3000, 400000, 15, 0, 0, 60*70, 5, [0, 15, 7], [0, .2, .2]]
		]

window.donations = {
    ...
    checkDonations: function() {
        ...
        window.donations.check(18, res.dirt >= 21, 50, "21 Dirt", dirtName, "Hey, answer me!");
        window.donations.check(19, res.dirt >= 30, 50, "30 Dirt", dirtName, "Guess this streamer doesn't read chat");
        window.donations.check(20, res.dirt >= 42, 50, "42 Dirt", "xXx420_N0sc0p3", "ayy");
        window.donations.check(21, res.cbotsMax >= 10, 200, "9 C.Bots Built", getRandomUsername(), "So many bots to handle. 200 IQ! ");

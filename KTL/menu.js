...
function createHelpForRealMenu() {
    return Raw.html`
        ...
        My discord to discuss everything is here: <a href="https://discord.gg/EmRuWPp" target="_blank">Stop_Sign Gaming</a>. I would really appreciate hearing about your suggestions and experience!
...
function createStoryMenu() {
    return Raw.html`<div class="menuTitle">Background</div>
        <div class="menuSeparator"></div><br>
&nbsp;&nbsp;&nbsp;&nbsp;A lich is a creature of bones, dark magic, and myth, causing catastrophes in history each time one appears. 13 years ago, the Emperor Brithan of Sovvgor had used one of his Talents to remove such a creature, though vanquishing had not come without great cost: a curse was laid upon the land. For hundreds of miles around the Dread Fortress far to the north, those who had Talents could not use them. These lands were mostly made of frozen wasteland, or dead cities turned into fuel for the liches ambition, but it did also encompass the majority of the Empire of Sovvgor - my home. The nobility informed us of our shared glory for bearing this burden with them, it was a bitter pill to swallow when Talents were our magic, our identity, and proof that Gods loved us. Talents are our connection to the idea that though the world is big, we have our place in it. With them gone... who would we be?<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;Sovvgor's small, long-term ally on our western border, Gryndall, started giving us unfavorable deals. They had been formerly pacified by our might, but realized they had advantages that tipped the scales: They could refine materials with Talents in ways we no longer could; they used their Talents to enchant items and cast magics. We lacked anything to balance the scales, forcing us to buy from them at a premium. When we ran out of coins to give, their greed only increased and their sights turned to our resources. After a forced diplomatic incident turned into a cry for war, the Emperor had no choice but to prepare an army.<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;It was only when my legs stopped carrying me to the next task, and my hands stayed idle at my sides, and my eyes felt no supernatural twitches to look to the next goal, that I finally realized the only reason I had been moving was Overclock churning through it's 13 year buildup of momentum. But then - all at once - it was empty, and I was still. At first, I stood there for hours, frozen with it all, thinking of everything and nothing, before finally simply using my senses to discover what my body had done while I wasn't paying attention. I had to find my own reasons for moving forward.<br><br>
        
&nbsp;&nbsp;&nbsp;&nbsp;I was in a recently abandoned hunter's cabin, having caught his widow traveling the other way. She looked kindly upon me when I presented her with a flower that reminded her of her deceased love, and said I could have the cabin and none would bother me. In the cabin I had the tools and supplies to let me survive the surrounding wilderness as long as I needed. I was not in my home in Sovvgor, nor in the betrayer Gryndal's lands, but instead in a country south of Gryndal, that I knew little of: Osric. Osric did not have a border wth Sovvgor, and so had not helped with the lich or interfered with Gryndal's claims.<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;Satisfied, I put this choice out of my mind, only to open it for comfort when I awoke in the night and little more. This had been a choice to have a fate-bending escape option prepared, should I need it, for whatever else fate had in store for me. Under the Emperor's curse, I had gotten used to daily life without it, and so it was fine - comforting, even - to keep the ability in reserve.<br><br>
        
&nbsp;&nbsp;&nbsp;&nbsp;After a few weeks of solitude and focusing on nothing but survival and preparation for winter - blessed stagnancy and repetition - it became obvious that a type of unfamiliar pressure was building: my ability was doing something I had not expected, and it was not simply building passively. I eventually came to realize the pressure became noticeably less as I performed tasks that would have been valid targets for Overclock. I was completing my daily chores quicker, but also I was having increasing trouble sitting still after the day's work, and when I had more time I would start to reflect on what got me here - which caused panic and terror and guilt I was desperately trying not to consider. Overclock, when targeting itself, was somehow still making me move, making me think... the momentum was spilling over, somehow. It seemed the choice was still mine for how to relieve the pressure, and so I threw myself into more work.<br><br>
...
function createChangelogMenu() {
    return Raw.html`
        ...
        <ol>
            ...
            <li>Removed resetting highest levels upon LS</li>
            <li>New Game+ is added, costing 1 million AW. 22 NG+ upgrades are available.</li>
        ...
        [Other changes]:<br>
        <ol>
            <li>Discord link updated to a permanent link</li>
            <li>Estimated Time to Level Option correctly works on refresh</li>
            <li>Zooming out applies the correct title on Destroy Eastern Monolith</li>
            <li>Now showing amount of upgrades bought on upgrade cards</li>
            <li>HATL decrease amount correctly shows 0 (fear is not consumed still)</li>
            <li>Updated some visual variables after Amulet/LS correctly</li>
            <li>Fixed an issue for new saves, causing them to never see Temper My Desires.</li>

let tutorial = [
    ...
    [ //2
        ...
        "Leveling up increases your Reflex Cap by 2. You'll use this in the next map. Use the arrow located next to War Map to move to the next town."
    ],
    [ //3
        "This map's first hideout has one more Thug - you won't be able to kill it as you are now. Use the new Train action 11 times (enough to get >10.2 RFLX) and then take down the first hideout."
    ],
    [ //4
